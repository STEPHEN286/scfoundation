...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="py-12 sm:py-24 bg-gradient-to-r from-blue-900 to-blue-800 text-white px-4 sm:px-6 lg:px-8">
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center">
                  <CheckCircle className="h-5 w-5 sm:h-6 sm:w-6 text-blue-600 mr-3" />
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-12">
            <Card className="bg-white shadow-lg border-t-4 border-t-blue-600">
              <CardContent className="p-6 sm:p-12 text-center">
                <Eye className="h-12 w-12 sm:h-16 sm:w-16 text-blue-600 mx-auto mb-4 sm:mb-6" />
            ...
            <Card className="bg-blue-600 text-white shadow-lg">
              <CardContent className="p-6 sm:p-12 text-center">
                ...
                <p className="text-lg sm:text-xl text-blue-100">Believe it, Live it and Love it.</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section className="py-12 sm:py-24 bg-blue-600 text-white px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-blue-100">Specific, measurable goals we work towards every day</p>
          </div>
